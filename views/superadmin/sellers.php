...
<div class="flex min-h-screen bg-gray-50">
  ...
  <main class="flex-1 px-8 py-8">
    <div class="flex items-center justify-between mb-6">
      <div>
        <h1 class="font-display font-semibold text-2xl text-gray-900">Sellers</h1>
        <p class="text-sm text-gray-500">Review applications and manage seller accounts.</p>
      </div>
    </div>

    <!-- Status filter -->
    <form method="GET" action="/superadmin/sellers" class="flex items-center gap-3 mb-6">
    ...
    <div class="bg-white border border-gray-200 rounded-lg overflow-hidden">
      <?php renderAccountsTable($sellers, $statusStyles, $sellerApplications); ?>
    </div>
