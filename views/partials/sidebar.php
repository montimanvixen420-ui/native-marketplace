 ...
 $__sidebarGroupsByRole = [
      ...
      'customer' => [
          ...
          ['label' => 'Shopping', 'items' => [
              ...
              ['key' => 'addresses', 'href' => '/addresses', 'label' => 'Shipping addresses',
               'icon' => '<path d="M12 21s7-5.1 7-11a7 7 0 10-14 0c0 5.9 7 11 7 11z"/><circle cx="12" cy="10" r="2.5"/>'],
              ...
              ['key' => 'reports', 'href' => '/reports', 'label' => 'My reports',
               'icon' => '<path d="M3 3v18h18"/><path d="M7 15l4-6 3 4 4-7"/>'],
          ]],
      ],
  ];
