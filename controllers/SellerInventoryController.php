...
class SellerInventoryController extends Controller {
  ...
  public function index():void{$sellerId=(int)$_SESSION['user_id'];$this->view('admin/inventory/index',['products'=>$this->products->allBySeller($sellerId),'posProducts'=>$this->pos->posProducts($sellerId),'active'=>'inventory','error'=>$_GET['error']??null]);}
